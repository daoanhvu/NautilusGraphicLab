				...
				public void mouseReleased(MouseEvent me) {
					...
					if( (mx > mapX0) && (mx < viewportWidth) ) {
						if( (my > mapY0) && (my < viewportHeight) ) {
							//drawPaneListener.
							offx = viewOffsX + mx - mapX0;
							c = offx / tileWidth + (offx%tileWidth==0?0:1);
							offy = viewOffsX + my - mapY0; 
							r = offy / tileHeight + (offy%tileHeight==0?0:1);
...
//					int offx = viewOffsX + evt.getX() - mapX0;
//					int c = offx / tileWidth;
//					int offy = viewOffsX + evt.getY() - mapY0; 
//					int r = offy / tileHeight;
		...
		public void render(Graphics2D g2) {
			...
			synchronized(mutex) {
				if(mapImage != null) {
//					g2.clipRect(viewOffsX, viewOffsY,
//							mapImage.getWidth() - viewOffsX, mapImage.getHeight() - viewOffsY);
					BufferedImage img = mapImage.getSubimage(viewOffsX, viewOffsY, viewportWidth, viewportHeight);
					g2.drawImage(img, mapX0, mapY0, 
...
//							this);
			...
			if(isMousePressed && (selectedTile>=0) ) {
				g2.drawImage(images.get(selectedTile), preMouseX, preMouseY, this);
			}
		}
